<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="privilege-signin.ascx.vb" Inherits="betatesting.privilege_signin" %>
...
<asp:Label ID="LblMsg" runat="server" Font-Bold="True" 
        Font-Size="Medium"></asp:Label>
            ...
            ControlToValidate="TxtEmailId" Display="None" ErrorMessage="Email Id Required!"></asp:RequiredFieldValidator>
            	...
            	<a href="/privilege-card/forgot-password/" style="color:#000;" >Forgot Password?</a>
