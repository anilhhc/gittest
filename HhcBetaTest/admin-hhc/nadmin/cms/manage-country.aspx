...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <h3>Manage Zones</h3>
            ...
            <asp:TextBox ID="TxtCountry" CssClass="form-control" placeholder="ZONE" runat="server"></asp:TextBox>
          ...
          <asp:Label ID="LblMsg" runat="server"></asp:Label>
            ...
            <asp:GridView ID="GVCountries" runat="server" AllowPaging="True" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Zone NAME" SortExpression="COUNTRYNAME">
                        <EditItemTemplate>
