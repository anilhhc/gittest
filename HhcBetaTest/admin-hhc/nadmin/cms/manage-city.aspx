...
<h1>Manage Cities</h1>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12" style=" margin:1% 0;">
      ...
      <div style="text-align:center;">       &nbsp;<asp:Button ID="BtnSave" runat="server" Text="Save" style="background: #0072bc;  color: white; border:1px #0072bc solid; margin:2% 0; text-align:center;"
                ValidationGroup="vgmanagecity" />

          <asp:Button ID="btnsearch" runat="server" Text="Seach" style="background: #0072bc;  color: white; border:1px #0072bc solid; margin:2% 0; text-align:center;"
                 />
