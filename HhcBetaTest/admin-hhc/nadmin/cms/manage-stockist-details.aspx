<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin-hhc/adminbasepage.master" CodeBehind="manage-stockist-details.aspx.vb" Inherits="betatesting.manage_stockist_details" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12" style="padding:2% 0;">    
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <asp:Label ID="lblstockistsapid" runat="server" Text="FullName"></asp:Label>
            </div>
            
            <div class="col-md-4 col-sm-4 col-xs-12">
                <asp:TextBox ID="txtstockistsapid" runat="server" Visible="false" CssClass="form-control"></asp:TextBox>
            </div>
            </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12" style="padding:2% 0;">    
            <div class="col-md-4 col-sm-4 col-xs-12">
                <b>Stockist Password</b>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
                <asp:Label ID="lblpwd" runat="server" Text="FullName"></asp:Label>
            </div>
            
            <div class="col-md-4 col-sm-4 col-xs-12">
                <asp:TextBox ID="txtpwd" runat="server" Visible="false" CssClass="form-control"></asp:TextBox>
            </div>
            </div>
             <div class="col-md-12 col-sm-12 col-xs-12" style="padding:2% 0;">    
            <div class="col-md-4 col-sm-4 col-xs-12">
...
<div class="col-md-12 col-sm-12 col-xs-12" style="padding:2% 0;">  
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <asp:Label ID="lblhscountry" runat="server" Text=""></asp:Label>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <asp:Label ID="lblhsstate" runat="server" Text=""></asp:Label>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
      <asp:DropDownList ID="ddlstate" runat="server"    CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="true" Width="100%" Height="30">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                            <asp:Label ID="lblhsheadquater" runat="server" Text=""></asp:Label>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <asp:Label ID="lblhssubarea" runat="server" Text=""></asp:Label>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
              <asp:DropDownList ID="ddlsubcity" runat="server"    CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="true" Width="100%" Height="30">
                        <asp:ListItem Value="">Select Sub City</asp:ListItem>
                      </asp:DropDownList>
            </div>
            </div>
            
            
                        <div class="col-md-12 col-sm-12 col-xs-12" style="padding:2% 0;" runat="server" visible="false">  
            ...
            <div style="text-align:center" >
                <asp:Button ID="btnedit" runat="server" Text="Update" style="background-color:#0072bc; border:1px #0072bc solid; color:#fff; width: 100px; padding:10px;"/>
