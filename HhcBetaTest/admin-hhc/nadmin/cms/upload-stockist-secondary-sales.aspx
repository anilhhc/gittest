<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin-hhc/adminbasepage.master" CodeBehind="upload-stockist-secondary-sales.aspx.vb" Inherits="betatesting.upload_stockist_secondary_sales" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div  >
    ...
    <div>
        <asp:DropDownList ID="ddlstockist" runat="server"   AppendDataBoundItems="false" AutoPostBack="true" Width="198" Height="30">
                        <asp:ListItem Value="">Multiple Stockist</asp:ListItem>
                      </asp:DropDownList>
     ...
     <div>
        ...
        <hr />
         ...
         <asp:GridView ID="GvBannerImages" runat="server"  AllowPaging = "true" pagesize="10000" >
           ...
           <asp:GridView ID="gvfulldata" runat="server"  AllowPaging = "true" visible="false"  AutoGenerateColumns="False" pagesize="10000">
                ...
                <Columns>
                         ...
                         <asp:BoundField DataField="stockistproductcode" HeaderText="Stockist Name" 
                            SortExpression="0" />
                       <asp:BoundField DataField="stockistproductcode" HeaderText="Stockist Sap Id" 
                            SortExpression="1" />
                     <asp:BoundField DataField="stockistproductcode" HeaderText="Month" 
                            SortExpression="2" />
                     <asp:BoundField DataField="stockistproductcode" HeaderText="Year" 
                            SortExpression="3" />
                    ...
                    <asp:BoundField DataField="purchasequantity" HeaderText="Purchase Quantity" 
                     ...
                     <asp:BoundField DataField="value" HeaderText="Value" 
                            SortExpression="13" />
                     <asp:BoundField DataField="stockistproductcode" HeaderText="Head Quarters" 
                            SortExpression="14" />


                      <asp:BoundField DataField="stockistproductname" HeaderText="Hetero Product Name" 
                            SortExpression="15" />
                     <asp:BoundField DataField="stockistproductname" HeaderText="Hetero Product Division Name" 
                            SortExpression="16" />
                    </Columns>
         ...
         <asp:Label ID="lblmonthnumber" runat="server" Text="" Visible="false"></asp:Label>
         <asp:Label ID="lblviewmode" runat="server" Text=""></asp:Label>
  <asp:Label ID="lblbdstatus" runat="server" Text=""></asp:Label>
