...
-- --------------------------------------------------
-- Date Created: 12/15/2017 22:50:04
...
GO
IF OBJECT_ID(N'[dbo].[Hdivision]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Hdivision];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Hproductslist]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Hproductslist];
GO
IF OBJECT_ID(N'[dbo].[Hproductslistdescription]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Hproductslistdescription];
GO
IF OBJECT_ID(N'[dbo].[Hstockistdetails]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Hstockistdetails];
GO
IF OBJECT_ID(N'[dbo].[hstockistupload]', 'U') IS NOT NULL
    DROP TABLE [dbo].[hstockistupload];
GO
IF OBJECT_ID(N'[dbo].[Htherapatic]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Htherapatic];
GO
IF OBJECT_ID(N'[dbo].[Hvendordetails]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Hvendordetails];
GO
IF OBJECT_ID(N'[dbo].[Hvproductslist]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Hvproductslist];
GO
...
GO
IF OBJECT_ID(N'[dbo].[subareaCITY]', 'U') IS NOT NULL
    DROP TABLE [dbo].[subareaCITY];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Usershetro]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Usershetro];
GO
IF OBJECT_ID(N'[dbo].[VENDORSPECIALIZATION]', 'U') IS NOT NULL
    DROP TABLE [dbo].[VENDORSPECIALIZATION];
GO
...
GO
IF OBJECT_ID(N'[dbo].[VENDORTYPESpecialisationsentry]', 'U') IS NOT NULL
    DROP TABLE [dbo].[VENDORTYPESpecialisationsentry];
GO
