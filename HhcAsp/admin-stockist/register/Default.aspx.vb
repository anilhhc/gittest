        ...
        Else
            ...
            If txtEmailId.Text <> "" Then
                Message = "<font face='Verdana' size='2'>Dear " & txtfirstname.Text & ", <br /><br />" & _
                        "<br /><br /></font>" & _
                        " Welcome to HHC. Following are the details to access the administrator control panel.<br /><br />" & _
                        "<br />URL '" & System.Configuration.ConfigurationManager.AppSettings("WebsiteURL") & "Aadmin-stockist/sign-in/'<br />" & _
                ...
                subject = "Stockist Login Details"
