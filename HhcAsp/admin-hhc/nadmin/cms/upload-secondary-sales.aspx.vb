...
Public Class upload_secondary_sales
    ...
    Protected Sub ImportExcel(sender As Object, e As EventArgs)
        ...
        ddlstockist.SelectedItem.Value = "0"
    ...
    Protected Sub gvfulldata_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvfulldata.DataBound
        ...
        For i = 0 To gvfulldata.Rows.Count - 1
            ...
            If gvfulldata.Rows(i).Cells(0).Text = "" Then

            Else
                gvfulldata.Rows(i).Cells(0).Text = dsstockits.getnamebysapid(gvfulldata.Rows(i).Cells(1).Text)

            End If

            If gvfulldata.Rows(i).Cells(14).Text = "" Then

            Else
                gvfulldata.Rows(i).Cells(14).Text = dsstockits.getheadquarterbysapid(gvfulldata.Rows(i).Cells(1).Text)

                gvfulldata.Rows(i).Cells(14).Text = dscity.GetValueByID(gvfulldata.Rows(i).Cells(14).Text)
            End If
            gvfulldata.Rows(i).Cells(2).Text = ddlmonth.SelectedItem.Text
            gvfulldata.Rows(i).Cells(3).Text = ddlyears.SelectedItem.Text
            ...
            Else
                ...
                Else
                    ...
                    gvfulldata.Rows(i).Cells(4).Text = dshprodcusts.getsapidbyproductid(gvfulldata.Rows(i).Cells(4).Text)
            ...
            For i = 0 To gvfulldata.Rows.Count - 1
                ...
                Else
                    ...
                    If gvfulldata.Rows(i).Cells(15).Text = "" Then
                        ...
                        lblanalysemsg.Text = "Product Not Mapped"
                    Else
                        gvfulldata.Rows(i).Cells(4).Text = dshprodcusts.getsapidbyproductid(gvfulldata.Rows(i).Cells(15).Text)
                        gvfulldata.Rows(i).Cells(15).Text = dshprodcusts.getnamebyid(gvfulldata.Rows(i).Cells(15).Text)
                    End If
