...
Public Class manage_vendor_products
    ...
    Dim dsvendorprodcuts As New HvproductslistnewTableAdapter
    ...
    Protected Sub BtnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        ...
        If BtnSave.Text = "Update" Then
            ...
            Else
                dsvendorprodcuts.Update(txtproductname.Text, txtproductdescription.Text, txtcompanycode.Text, ddlproducts.SelectedItem.Value, lblstockist.Text, ddlproducts.SelectedItem.Text, ddlstockist.SelectedItem.Text, fileId.Text)
                BtnSave.Text = "Save"
        ...
        Else
            ...
            If dsvendorprodcuts.getprimarycount(txtproductname.Text, txtcompanycode.Text, ddlstockist.SelectedItem.Value) > 0 Then
                ...
                LblMsg.Text = "Vendor Product :" & txtproductname.Text & "or vendor Product Code" & txtcompanycode.Text & "already added for Stockist" & ddlstockist.SelectedItem.Text
            Else
                dsvendorprodcuts.Insert(txtproductname.Text, txtproductdescription.Text, txtcompanycode.Text, ddlproducts.SelectedItem.Value, ddlstockist.SelectedItem.Value, ddlproducts.SelectedItem.Text, ddlstockist.SelectedItem.Text)
            End If
 ...
 GVPrintNews.DataSource = dsvendorprodcuts.GetData
    ...
    Protected Sub GVPrintNews_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVPrintNews.RowCommand
        If e.CommandName = "CmdEdit" Then
            ...
            If DtImages.Rows.Count > 0 Then
                ...
                lblstockist.Text = dtrow("hvstockistid")
    ...
    Protected Sub GVPrintNews_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GVPrintNews.RowDataBound
    ...
    Protected Sub ddlproducts_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlproducts.SelectedIndexChanged
        If ddlproducts.SelectedIndex > 0 Then
            txtcompanycode.Text = dsprodcuts.getsapidbyproductid(ddlproducts.SelectedItem.Value)
        End If
    End Sub
End Class
