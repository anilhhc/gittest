...
Public Class upload_file
    ...
    Protected Sub gvfulldata_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvfulldata.DataBound
        ...
        For i = 0 To gvfulldata.Rows.Count - 1
                ...
                If gvfulldata.Rows(i).Cells(1).Text = "" Then

                    gvfulldata.Rows(i).Cells(9).Text = "Product Not Found"

                'lblanalysemsg.Text = "Products Mapping should be done"
                Else
                    gvfulldata.Rows(i).Cells(9).Text = dsvendorproducts.getidbystockitname(gvfulldata.Rows(i).Cells(1).Text, lblstockist.Text)

                    If gvfulldata.Rows(i).Cells(9).Text = "" Then
                    gvfulldata.Rows(i).Cells(9).Text = "Product Not Mapped"
                    lblanalysemsg.Text = "Product Not Mapped"
                    Else
                        gvfulldata.Rows(i).Cells(9).Text = dshprodcusts.getnamebyid(gvfulldata.Rows(i).Cells(9).Text)
                    End If
